...
<script type="text/javascript" src="<%=path %>/chat/plug/qqFace/js/jquery.qqFace.js"></script><!-- 引入录音文件 -->
...
<body>
   ...
   <div style="width: 95%;float:left;" >
   	   <!--    聊天内容展示区 -->
	   <div style="width: 100%; height: 20px;margin:10px 0 5px 10px;font-weight:bold;">
	   	     <span>
				<img id="backButton" src="<%=path %>/chat/image/back.png" style="width:20px;height:20px;margin-top:-3px;cursor:pointer;"  onclick="javascript:window.location.href='<%=path%>/group?method=getList';"/>
	   	     </span>
	   ...
	   <div style="width: 100%; height: 300px; overflow-y: auto; border: 1px solid #ccc; margin:10px 0 0 10px;padding-top:10px;" id="showChatMessage">
		   <!-- 		  如果消息数量大于20条 ，显示加载更多 -->
	   ...
	   <div id="chatFunArea" style="width:100%;height:18px;border:0px solid blue;margin:3px 0 3px 0;margin:10px 0 0 10px;">
			...
			<div style="width:100px;height:30px;font-size:12px;line-height:30px;border:1px solid #ccc;background-color:white;position:absolute;margin:0 0 0 56px;display:none;">
   	 			...
   	 			<div style="width:120px;height:25px;float:left; padding-left:3px;font-size:10px;">
   	 				<div style="width:100%;height:10px;font-size:10px;">
   	 					<c:if test="${user.onlineStatus == 1 }">
   	 						<img src="<%=path %>/chat/image/online.png" title="在线"/>
   	 					</c:if>
