...
<head>
    ...
    <script src="plugin/bootstrap/jquery-1.8.3.min.js"></script>
    ...
    <div id="register" class="modal fade" tabindex="-1">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group" action="<%=path %>/enrooll">
                            <div class="form-group">
                                <label for="">用户名</label>
                                <input name="account" class="form-control" type="text" placeholder="6-15位字母或数字">
                            </div>
                            <div class="form-group">
                                <label for="">密码</label>
                            ...
                            <div class="form-group">
                                ...
                                <input name="passwordtwo" class="form-control" type="password" placeholder="至少6位字母或数字">
                            </div>
                            <div class="form-group">
                                <label for="">邮箱</label>
