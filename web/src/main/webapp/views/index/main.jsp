...
<body class="easyui-layout">
	<!-- 顶部banner -->
    <div id="header" data-options="region:'north'," style="height:80px;background:url(${ctx}/images/top_logo.png) no-repeat #105FA5">
	    <div style="width:400px;border:0px solid blue;float:right;text-align:right;">
	    	<div id="timeShow" style="height:45px;width:90%;color:white;line-height:60px;border:0px solid blue;">
	    		
	    	</div>
	    	<div style="height:30px;width:90%;">
	    		<span style="font-size:15px;color:white;"><span style="color:white;">${loginUser.userName }</span>，你好！</span>
	    		<img title="修改密码" src="${ctx }/easyui/themes/icons/changePwd.png" style="cursor:pointer;margin-bottom:-3px;"/>
	    		<img title="退出登录" onclick="quit();" src="${ctx }/easyui/themes/icons/quit.png" style="cursor:pointer;margin-bottom:-3px;margin-left:10px;"/>
	    		<img title="帮助" src="${ctx }/easyui/themes/icons/help1.png" style="cursor:pointer;margin-bottom:-3px;margin-left:10px;"/>
	    	</div>
		</div>
    </div>
	<!-- 左侧导航菜单 -->
