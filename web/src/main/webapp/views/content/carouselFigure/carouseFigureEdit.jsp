...
<form id="addOrEditForm" method="post" enctype="multipart/form-data" action="">
     ...
     <table id="myTable" cellpadding="0" cellspacing="0">
        <tr>
     	...
     	<tr>
          	<td class="td_class_1"><label>平台：<span style="color:red;">*</span></label></td>
			<td class="td_class_2">
				<input data-options="
				valueField:'dictValue',
				textField:'dictName',
				url:'${ctx }/dict/getDictByKey.do?dictKey=PLATFORM',
				onSelect:function(data){}" class="easyui-combobox" style="width:250px;height:25px;" id="platform" name="platform" required="true" value="${data.platform}" style="height:30px;"/>
			</td>
	    </tr>
     	<tr>
