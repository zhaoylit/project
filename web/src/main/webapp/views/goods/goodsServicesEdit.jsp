...
<form id="addOrEditForm" method="post" enctype="multipart/form-data" action="">
     ...
     <table id="myTable" cellpadding="0" cellspacing="0">
     	<tr>
          	<td class="td_class_1"><label>服务名称：<span style="color:red;">*</span></label></td>
			<td class="td_class_2">
				<input class="easyui-textbox" style="width:250px;height:25px;" id="serviceName" name="serviceName" required="true" value="${data.serviceName}" style="height:30px;"/>
			</td>
	    </tr>
        <tr>
          	<td class="td_class_1"><label>服务图标：<span style="color:red;">*</span></label></td>
