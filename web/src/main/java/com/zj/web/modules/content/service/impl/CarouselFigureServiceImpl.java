...
public class CarouselFigureServiceImpl implements ICarouselFigureService {
	...
	public List<Map> selectList(Map params, Page page)
		...
		//获取资源访问路径
		List<Map> selectList = carouselFigureMapper.selectList(params,new RowBounds(page.getStartItem(), page.getNumPerPage()));
	...
	public List<Map> selectList(Map params) throws Exception {
		// TODO Auto-generated method stub
		List<Map> selectList = carouselFigureMapper.selectList(params);
		for(Map mm : selectList){
			String iamgeUrl = ParamsUtil.nullDeal(mm, "imageUrl", "");
			if(!"".equals(iamgeUrl) && !iamgeUrl.contains(RETURN_PATH)){
				mm.put("imageUrl", RETURN_PATH + iamgeUrl);
	...
	public Map selectOne(Map params) throws Exception {
		// TODO Auto-generated method stub
		Map oneMap = carouselFigureMapper.selectOne(params);
		if(oneMap != null){
		...
		return carouselFigureMapper.selectOne(params);
	}
	
	@Override
	public int insert(Map params) throws Exception {
		// TODO Auto-generated method stub
		return carouselFigureMapper.insert(params);
	}

	@Override
	public int updateByPrimaryKeySelective(Map params) throws Exception {
		// TODO Auto-generated method stub
		return carouselFigureMapper.updateByPrimaryKeySelective(params);
	}
	...
	public int deleteByPrimaryKey(Map params) throws Exception {
		...
		return carouselFigureMapper.deleteByPrimaryKey(idsArray);
	}

	@Override
	public int selectCount(Map params) throws Exception {
		// TODO Auto-generated method stub
		return carouselFigureMapper.selectCount(params);
	}
	...
	public int updateSort(Map params) throws Exception {
		...
		for(int i = 0;i < idsArray.length ;i++){
			...
			rowCount += carouselFigureMapper.updateByPrimaryKeySelective(updateMap);
		}
		return rowCount;
	}
}
