package com.zkkj.backend.web.controller.base.system;
...
public class VerifyCodeAction extends BaseController {
    ...
    public void getCode(HttpServletRequest req, HttpServletResponse resp) throws ServletException, java.io.IOException { 
    	initCode();
        // 定义图像buffer         
        ...
        session.setAttribute(IConstant.VALIDATE_CODE, randomCode.toString());         
        // 禁止图像缓存。         
