...
public class ReflectUtil {
	...
	public static Map<String,Object> transToMAP(Map parameterMap){
		...
		HttpServletRequest request = ((ServletRequestAttributes)RequestContextHolder.getRequestAttributes()).getRequest();  
	      ...
	      if (request.getSession().getAttribute("userDeviceId")!=null ) {
	    	  String userDeviceIdString = (String) request.getSession().getAttribute("userDeviceId");
	    	  returnMap.put("userDeviceId", userDeviceIdString);
		}
