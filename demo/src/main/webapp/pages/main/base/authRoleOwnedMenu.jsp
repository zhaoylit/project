	...
	<!-- 菜单编辑 -->
        <div class="easyui-layout" style="width:100%;height:500px;">
			<div id="p" data-options="region:'west',split:true,checkbox:true" style="width:25%;padding:10px">
				 <ul class="easyui-tree" id="menuTree"  data-options="lines:true,animate:true,checkbox:true,cascadeCheck:false,onlyLeafCheck:false,url:'menu/getRoleTreeMenu.do?parentId=c048499ace69b9df563c6b2fc17e841320161130091724&roleId=${roleId}'"></ul>
			</div>
