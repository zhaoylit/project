           ...
           $(function() { 
        	  ...
        	  $("#Airway").combobox({
	 			...
	 			columns:[[
					...
					{field:'airlineCode',title:'航空公司代码',width:'45%',align:'center'},
					{field:'airlineName',title:'航空公司名称',width:'45%',align:'center'},
	 		    ...
	 		    onBeforeLoad:function(data){
	 		        ...
	 		        if($(".searchBox").length == 0){
	                     ...
	                     searchTool+='<td>航空公司:&nbsp;<input id="airport" style="width:15%;height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
...
//              提交之前做的表单验证
              ...
              if($form.form('validate')){
                  $.ajaxFileUpload({
                      ...
                      url:'<%=path%>/info/uploadairline.do',
