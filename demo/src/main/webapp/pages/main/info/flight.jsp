...
<div class="msg">
       <div class="msg_left">
            <form id="flight_message" method="post" class="Form" enctype="multipart/form-data">
		        <p>
		                          导入.xls/xlsx格式的文件,每行一个航班信息,包括航班号,城市,起飞时间,各个信息用逗号分割,例如<br/>
		            cz1, 京/沪, 0630<br/>
		            cz2, 京/藏, 0715<br/>
		            cz3, 京/昆, 0730
		        </p>
		        ...
		        <div class="airport" style=""><br/>
		            ...
		            <input class="easyui-validatebox" type="text" name="airport"   id="airport" style="height:38px;width:100%;"/>
		        </div>
       ...
       <div class="msg_right">
                   <table id="flightList" style="width:100%;margin:0px;"></table>
       </div>
</div>
</body>   
        ...
        //页面表格的初始化
           $(function() { 
        	  ...
        	  $("#airport").combobox({
	         	...
	         	/*  加载页面时初始化数据表格 */
	 			$('#flightList').datagrid({
	 		    url:'<%=path%>/info/getFlightInfo.do',
	 		    toolbar:'#tb',
	 		    fit:true,
	 		    method:'post',
	 		    loadMsg:'数据加载中,请稍等...',
	 			...
	 			columns:[[
					...
					{field:'depCity',title:'出发地',width:'15%',align:'center'},
					{field:'passCity',title:'经停地',width:'15%',align:'center'},
					{field:'arrCity',title:'目的地',width:'18%',align:'center'},
					{field:'takeoffTime',title:'预计起飞时间',width:'25%',align:'center'},
	 		    ]],
	 		    onBeforeLoad:function(data){
	 		    	//添加搜索条件
	 		        if($(".searchBox").length == 0){
	 			        var searchTool = '<div class="searchBox" style="padding:3px 0 0 25px;height:40px;line-height:30px;">';
	                     searchTool+='<td>指定航班号:&nbsp;<input id="flightNo" style="width:15%;height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
...
//              提交之前做的表单验证
               ...
               var airport=$("#airport").parent().find("input[name='airport']").val();
               var file=$("#file").val()
              if(beginTime==''){
