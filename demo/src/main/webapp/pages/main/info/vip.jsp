           ...
           $(function() { 
        	  ...
        	  $("#Airway").combobox({
	 			...
	 			columns:[[
					...
					{field:'viplevel',title:'VIP等级',width:'15%',align:'center'},
					{field:'viproom',title:'VIP厅',width:'15%',align:'center'},
					{field:'takeoff',title:'机场',width:'18%',align:'center'},
					{field:'location',title:'地点',width:'25%',align:'center'},
					{field:'remark',title:'VIP记录',width:'18%',align:'center'},
	 		    ]],
	 		    onBeforeLoad:function(data){
	 		    	//添加搜索条件
	 		        if($(".searchBox").length == 0){
	 			        var searchTool = '<div class="searchBox" style="padding:3px 0 0 25px;height:40px;line-height:30px;">';
	                     searchTool+='<td>姓名:&nbsp;<input id="name" style="width:15%;height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
