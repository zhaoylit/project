...
<div class="msg">
       <div class="msg_left">
            <form id="vip_message" method="post" class="Form" enctype="multipart/form-data">
		        <p>
		             请导入.xls/xlsx格式的文件
		        </p>
		        <div class="beginTime">
           ...
           $(function() { 
        	  ...
        	  $("#Airway").combobox({
	 			...
	 			columns:[[
					...
					{field:'viproomName',title:'VIP厅ID',width:'55%',align:'center'},
					{field:'apId',title:'机场序号',width:'35%',align:'center'}
	 		    ]],
	 		    onBeforeLoad:function(data){
	 		    	//添加搜索条件
	 		        if($(".searchBox").length == 0){
	 			        var searchTool = '<div class="searchBox" style="padding:3px 0 0 25px;height:40px;line-height:30px;">';
	                     searchTool+='<td>VIP厅:&nbsp;<input id="viproom" style="width:15%;height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
...
//              提交之前做的表单验证
              ...
              if($form.form('validate')){
                  $.ajaxFileUpload({
                      ...
                      url:'<%=path%>/info/uploadViproom.do',
