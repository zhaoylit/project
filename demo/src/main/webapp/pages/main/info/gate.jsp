...
<div class="msg">
       <div class="msg_left">
            <form id="gate_message" method="post" class="Form" enctype="multipart/form-data">
		        <p>
		                                 请导入.xls/xlsx格式的文件     
		        </p>
		        <div class="beginTime">
       ...
       <div class="msg_right">
                   <table id="gateList" style="width:100%;margin:0px;"></table>
       </div>
</div>
           ...
           $(function() { 
        	  ...
        	  $("#airport").combobox({
	 			...
	 			columns:[[
					...
					{field:'airport',title:'机场',width:'35%',align:'center'},
					{field:'gate',title:'登机口',width:'25%',align:'center'},
	 		    ]],
	 		    onBeforeLoad:function(data){
	 		    	//添加搜索条件
	 		        if($(".searchBox").length == 0){
	 			        var searchTool = '<div class="searchBox" style="padding:3px 0 0 25px;height:40px;line-height:30px;">';
	                     searchTool+='<td>指定登机口:&nbsp;<input id="gate" style="width:15%;height:30px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>';
