<%@ page language="java" import="java.util.*,com.zkkj.backend.common.util.*" pageEncoding="UTF-8"%>
<%
...
<script src="${ctx }/pages/plugins/hightchart/highcharts.js"></script>
<script src="${ctx }/pages/plugins/hightchart/modules/exporting.js"></script>
	   ...
	   <div class="banner" style="">
		   ...
		   <c:if test="${isDF ==true }">
			<div class="easyui-panel banner_head" style="padding:10px;">
				...
				<a href="javascript:void();" onclick="javascript:toPage('寻找旅客','initDemo.do')" class="easyui-menubutton" id="index_guide">进出监控</a>
				<a href="${ctx}/pages/main/guide/guide.jsp" target="_blank" class="easyui-menubutton"  id="index_shuoming">使用说明书</a>
			</div>
			<div id="mm1" class="menu-content" style="text-align:center;">
				<div>
				     <a  href="javascript:toPage('寻找旅客','pages/main/notice/noticePer.jsp')" style="font-size:1rem;color:#fff">寻找旅客</a>
				</div>
				<div>
				     <a class="nav-link" href="javascript:toPage('航班提醒','pages/main/notice/noticeFlight.jsp')" style="font-size:1rem;color:#fff">航班提醒</a>
				</div>
			</div>
			<div id="mm2" style="text-align:center;" class="menu-content">
				<div>
				     <a href="javascript:toPage('寻找旅客查询','pages/main/history/query_per.jsp')" style="font-size:1rem;color:#fff">寻找旅客发布记录查询</a>
				</div>
				<div>
				     <a href="javascript:toPage('航班提醒查询','pages/main/history/query_flight.jsp')" style="font-size:1rem;color:#fff">航班提醒发布记录查询</a>
				</div>
			 <!-- <div>
...
<!-- 			
		    <div title="测试菜单" data-options="iconCls:'icon-application-form-edit'" style="padding:5px;">
				<ul class="easyui-tree wu-side-tree">
					...
					<li iconCls="icon-chart-organisation"><a href="javascript:toPage('异常菜单','/exception/exceptionRecordInit.do')" data-icon="icon-chart-organisation" data-link="layout-3.html" iframe="0">设备异常管理</a></li>
					<li iconCls="icon-chart-organisation"><a href="javascript:toPage('设备管理菜单','device/deviceManageInit.do')" data-icon="icon-chart-organisation" data-link="layout-3.html" iframe="0">设备监控</a></li>
					<li iconCls="icon-chart-organisation"><a href="javascript:toPage('apk远程更新','apk/synchApkInit.do')" data-icon="icon-chart-organisation" data-link="layout-3.html" iframe="0">apk远程更新</a></li>
				</ul>
			</div> -->
...
// 		$(".panel-body-noheader").css({"background-color":"#0864aa !important"});
     ...
     $("[iconCls='icon-add']").click(function(){
        ...
        <audio id="audio" src="<%=path %>/main/message.mp3"></audio>
        <div id="message" style="display:none;border:#b9c9ef 1px solid;z-index:100;width:300px;position:absolute;background:#cfdef4; bottom:0; right:0; overflow:hidden;">
	        <div style="border:1px solid #fff;border-bottom:none;width:100%;height:20px;font-size:12px;overflow:hidden;color:#1f336b;">
	        	<span id="message_close" style="float:right;padding:2px 0 5px 0;width:16px;line-height:auto;color:red;font-size:12px;font-weight:bold;text-align:center;cursor:pointer;overflow:hidden;">×</span>
	       	 	<div style="padding:2px 0 2px 5px;width:100px;line-height:18px;text-align:left;overflow:hidden;">
	       	 		消息提示
	        	</div>
	        	<div style="clear:both;"></div>
	        </div> 
	        <div style="padding-bottom:5px;border:1px solid #fff;border-top:none;width:100%;height:auto;font-size:12px;">
		        <div id="message_content" style="margin:0 5px 0 5px;border:#b9c9ef 1px solid;padding:10px 0 10px 5px;font-size:12px;width:283px;height:150px;color:#1f336b;text-align:left;overflow:hidden;">
