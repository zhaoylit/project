...
<style type="text/css">
   ...
   <!--    广告位图片类型 -->
   <c:if test="${resultInfo.adtype == 'image' }">
        <div class="media">
            <div class="media-total">
               <h4>图片的全屏文件</h4>
   		       <img src="${resultInfo.path1 }" style="width:60%;display: block;margin: 20px auto;">
            </div>
            <div class="media-half">
                <h4>图片的半屏文件</h4>
                <img src="${resultInfo.path2 }" style="width:60%;display: block;margin: 20px auto;">
            </div>
        </div>
   </c:if>
   <!--    广告位视频类型 -->
    <c:if test="${resultInfo.adtype == 'video' }">
        <div class="media">
            <div class="media-total">
               <h4 style="margin-bottom:20px;">视频的全屏文件</h4>
   		       <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="380px;" height="300px"
				      ...
				      data-setup="{}">
				    <source src="${resultInfo.path1 }" type='video/mp4' />
            ...
            <div class="media-half">
                ...
                <video id="example_video_1" class="video-js vjs-default-skin" controls preload="none" width="380" height="300px"
				      poster="http://video-js.zencoder.com/oceans-clip.png"
				      data-setup="{}">
				    <source src="${resultInfo.path2 }" type='video/mp4' />
				    <track kind="captions" src="demo.captions.vtt" srclang="en" label="English"></track><!-- Tracks need an ending tag thanks to IE9 -->
				    <track kind="subtitles" src="demo.captions.vtt" srclang="en" label="English"></track><!-- Tracks need an ending tag thanks to IE9 -->
				</video>
            </div>
